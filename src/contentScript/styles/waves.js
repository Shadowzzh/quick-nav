...
;(function (window) {
  ...
  function showEffect(e) {
    ...
    if (element !== null) {
      ...
      element.addEventListener('dragend', Effect.hide)
    }
  }
  ...
  Waves.attach = function (element) {
    ...
    if ('ontouchstart' in window) {
      element.addEventListener('touchstart', showEffect)
    }

    element.addEventListener('mousedown', showEffect)
  }
